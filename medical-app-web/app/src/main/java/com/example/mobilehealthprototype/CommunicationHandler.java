...
public class CommunicationHandler {
    ...
    public String generateRawMessage(String p_id, Sex p_sex, int p_age, float p_height, float p_weight,
                                     ArrayList<Integer> patientSymptomsIndex, int diagnosedDiseaseIndex,
                                     String lab_test, String lab_result, String prescription, String dosage){
        ...
        String sh = fh + symps + ";" + diagnosedDiseaseIndex + ";" + lab_test + "," + lab_result + ";" + prescription + "," + dosage;
        Log.d("TESTING", sh);
        return sh;
    }
